...
python = Language.find(1)
python.docs.attach(io: File.open('./python3doc.pdf'), filename: 'python3doc.pdf')
python.docs.attach(io: File.open('./pythondoc.pdf'), filename: 'pythondoc.pdf')
...
gatinho = Student.find_by(name: "Artur")
gatinho.profile_pic.attach(io: File.open('./gatin.jpeg'), filename: 'gatin.jpeg')

Admin.create(email: 'adm@admin' , password: 'password')